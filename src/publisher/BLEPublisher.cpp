    ...
    switch (event) {
        ...
        case ESP_GATTS_CREATE_EVT:
            ...
            esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle,
                                   ...
                                   (esp_gatt_char_prop_t) (ESP_GATT_CHAR_PROP_BIT_READ | ESP_GATT_CHAR_PROP_BIT_WRITE |
        ...
        case ESP_GATTS_ADD_CHAR_EVT: {
            ...
            esp_ble_gatts_add_char_descr(gl_profile_tab[PROFILE_A_APP_ID].service_handle,
                                         ...
                                         (esp_gatt_perm_t) (ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE), NULL, NULL);
            break;
        }
...
void BLEPublisher::publishEmergencySignal() {

}

void BLEPublisher::doWork() {
    Publisher::doWork();
}
